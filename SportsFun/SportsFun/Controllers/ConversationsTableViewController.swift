...
class ConversationsTableViewController: UITableViewController {
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    case "ShowConversation":
      guard let conversationTableViewController = segue.destination as? ConversationTableViewController else {
      ...
      conversationTableViewController.conversationId = selectedConversation.id
    default:
